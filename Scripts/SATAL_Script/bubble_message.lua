do
    ...
    local numPlayersInBufferZone = trigger.misc.getUserFlag('64')
    ...
    if(bubbleActiveCount ~= 0)then
        ...
        if (#playerNamesOutOfBufferZone > 0)then
            ...
            trigger.action.outText("WARNING! Leaving CombatZone: " .. names, 1,false)
        ...
        if(#playerNamesOutOfBufferZone > numPlayersInBufferZone)then
    ...
    trigger.action.setUserFlag('64',#playerNamesOutOfBufferZone)
